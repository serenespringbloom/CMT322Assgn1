        ...
        <table class="min-w-full bg-white border border-gray-200">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th class="py-2 px-4 border-b text-left">Merchandise Type</th>
          ...
          <tbody>
            <tr v-for="merch in tableData" :key="merch.items_id" class="hover:bg-gray-50">
              <td class="py-2 px-4 border-b">{{ merch.merch_id }}</td>
              <td class="py-2 px-4 border-b">{{ merch.merch_category }}</td>
              <td class="py-2 px-4 border-b">{{ merch.quanity }}</td>
              <td class="py-2 px-4 border-b">{{ merch.size }}</td>
