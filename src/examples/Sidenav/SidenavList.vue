  ...
  >
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          to="/feedback"
          :class="getRoute() === 'feedback' ? 'active' : ''"
          :navText="isRTL ? 'الجداول' : 'Feedback'"
        >
          <template v-slot:icon>
            <i
      ...
      <li class="nav-item">
        <sidenav-item
          to="/event"
          :class="getRoute() === 'event' ? 'active' : ''"
          :navText="isRTL ? 'الفواتیر' : 'Event'"
        >
          <template v-slot:icon>
            <i class="fa fa-sticky-note text-primary text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      </li>
